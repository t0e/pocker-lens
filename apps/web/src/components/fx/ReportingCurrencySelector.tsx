...
> = ({ currentCurrency, onCurrencyChange, className = '' }) => {
  ...
  return (
    <div
      className={`flex items-center gap-2 bg-slate-800/80 border border-slate-700/80 rounded-lg px-2.5 py-1.5 ${className}`}
    >
