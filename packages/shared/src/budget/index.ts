...
export const CreateBudgetSchema = z.object({
  ...
  month: z.string().regex(MONTH_REGEX, 'Month must be in YYYY-MM format (e.g. 2026-08)'),
});
...
export const CopyBudgetsSchema = z.object({
  fromMonth: z.string().regex(MONTH_REGEX, 'fromMonth must be in YYYY-MM format'),
 ...
 */
export function getMonthBounds(monthStr: string): { startOfMonth: Date; endOfMonth: Date } {
